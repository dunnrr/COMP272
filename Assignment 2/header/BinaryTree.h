...
BinaryTree<E>::Position<E> BinaryTree<E>::root() const
{
	return Position(_root);
}

template <typename E>						//preorder list of nodes
BinaryTree<E>::PositionList<E> BinaryTree<E>::prePositions() const
{
	PositionList<E> pl;
...
BinaryTree<E>::PositionList<E> BinaryTree<E>::postPositions() const
{
	PositionList<E> pl;
...
BinaryTree<E>::PositionList<E> BinaryTree<E>::inPositions() const
{
	PositionList<E> pl;
...
void BinaryTree<E>::preorder(Node* v, PositionList<E>& pl) const
{
...
void BinaryTree<E>::postorder(Node* v, PositionList<E>& pl) const
{
	if (v->left != nullptr)					//traverse left subtree
		postorder(v->left, pl);
	if (v->right != nullptr)				//traverse right subtree
...
void BinaryTree<E>::inorder(Node* v, PositionList<E>& pl) const
{
	if (v->left != nullptr)					//traverse left subtree
		inorder(v->left, pl);
	pl.push_back(position(v));				//add this node
